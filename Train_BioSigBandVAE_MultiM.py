...
if __name__ == "__main__":
    ...
    EncModel = Encoder(SigDim=SigDim, LatDim= LatDim, Type = '', MaskingRate = MaskingRate, NoiseStd = NoiseStd, MaskStd = MaskStd, ReparaStd = ReparaStd, Reparam=True)
    ...
    SigBandRepModel.fit(TrData, batch_size=3500, epochs=650, shuffle=True, validation_data =(ValData, None) , callbacks=[  RelLoss]) 
