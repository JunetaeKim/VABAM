...
if __name__ == "__main__":
    ...
    SavePath = './Results/'
    ModelName = 'TCL_'+str(SigType)+'_Z'+str(LatDim)+'_Comp'+str(CompSize)+'.hdf5'
    ...
    ScalingDic = { 'val_ReconOut_ext':WRec, 'val_FeatRecLoss':WFeat, 'val_kl_Loss_Z':WZ, 'val_kl_Loss_FC':WFC, 'val_kl_Loss_TC':WTC}
    MinLimit = {'Beta_Rec_ext':MnWRec, 'Beta_Feat':MnWFeat, 'Beta_Z':MnWZ, 'Beta_Fc':MnWFC, 'Beta_TC':MnWTC}
    MaxLimit = {'Beta_Rec_ext':MxWRec, 'Beta_Feat':MxWFeat, 'Beta_Z':MxWZ, 'Beta_Fc':MxWFC, 'Beta_TC':MxWTC}
