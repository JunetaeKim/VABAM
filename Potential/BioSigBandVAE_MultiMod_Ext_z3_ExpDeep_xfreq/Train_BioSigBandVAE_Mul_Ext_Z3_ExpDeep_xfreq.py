...
if __name__ == "__main__":
    ...
    #### -----------------------------------------------------   Experiment setting   -------------------------------------------------------------------------    
    SavePath = './Results/'
    ModelName = 'SigBandRep_MultMod_Ext_Z3_ExpDeep_xfreq.hdf5'
    ...
    MaxLimit = {'Beta_Rec_ext':500., 'Beta_Feat':500., 'Beta_Z':0.2, 'Beta_Fc':0.2}
    ...
    SigBandRepModel.fit(TrData, batch_size=3000, epochs=700, shuffle=True, validation_data =(ValData, None) , callbacks=[  RelLoss]) 
