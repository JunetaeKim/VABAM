...
if __name__ == "__main__":
    ...
    SavePath = './Results/'
    ModelName = 'SigBandRep_MultMod_Ext_Z'+str(LatDim)+'_ExpDeep_TCL_test2.hdf5'
    ...
    SigBandRepModel.fit(TrData, batch_size=3000, epochs=400, shuffle=True, validation_data =(ValData, None) , callbacks=[  RelLoss]) 
