...
if __name__ == "__main__":
    ...
    RelLossDic = { 'val_ReconOutExt':'Beta_Rec_ext', 'val_FeatRecLoss':'Beta_Feat', 'val_kl_Loss_Z':'Beta_Z', 'val_kl_Loss_FC':'Beta_Fc', 'val_kl_Loss_TC':'Beta_TC'}
    ScalingDic = { 'val_ReconOutExt':100., 'val_FeatRecLoss':200., 'val_kl_Loss_Z':0.1, 'val_kl_Loss_FC':0.1, 'val_kl_Loss_TC':0.1}
