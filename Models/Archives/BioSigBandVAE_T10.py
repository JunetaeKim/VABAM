...
def MaskingGen ( InpRegul, MaskingRate = 0.025, MaskStd = 0.1):
    ...
    ## Noise vector generation 1 vs 0; In the Encoder, backpropagation is controlled by masking {0 vs 1}; In the Encoder output part, noise is added to the previously masked part.
